(function(window){
	...
	var dialog = {
		...
		loading: function(options){
			...
			addClass(bgDiv, "dialog-loading-bg");
			addClass(loadDiv, "dialog-loading");
			addClass(loadDiv, "animation-" + opts.animationType + "-in");
			
			if(opts.hint){
				addClass(loadDiv, "dialog-loading-hint");
